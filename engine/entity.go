...
/*
Create creates a new entity, optionally with the specified empty components
*/
func (db EntityDB) Create(components ...string) Entity {
    eid := db.nextid
    db.nextid++
...
*/
func (db EntityDB) Remove(eid Entity) {
